  ...
  <section class="flexo__nav" id="top">
          ...
          <section class="flexo-modal mobile">
              <div class="container">
                  <div class="flexo-modal__menu">
                      ...
                      <a href="#offer"><div class="flexo-modal__menu-element">Oferta</div></a>
                      <a href="#about"><div class="flexo-modal__menu-element">O nas</div></a>
          ...
          <div class="flexo-topbar__container">
              <nav class="flexo-topbar__menu">
                  ...
                  <div class="flexo-topbar__menu-element flexo-topbar__menu-list desktop">
                      ...
                      <a href="#offer"><div class="flexo-topbar__menu-list-element">Oferta</div></a>
                      <a href="#about"><div class="flexo-topbar__menu-list-element">O nas</div></a>
    ...
    <section class="flexo-landing">
      ...
      <div class="flexo-landing__header">
        <h1 class="header flexo__title">Sedno druku <br>i opakowań</h1>
      </div>
    </section>
        ...
        <div class="container">
            ...
            <div class="flexo-about__company-offer" id="offer">
                ...
                <div class="flexo-about__info">
                    ...
                    <h2 class="flexo-about__company-offer--title">Projektowanie</h2>
                    <p class="flexo-about__company-offer--text">Kreujemy logotypy i tworzymy grafiki do pojedynczych opakowań lub całych serii z zachowaniem spójnego wyglądu i estetyki. Zaakceptowane wzory są od początku przygotowywane z myślą o druku i formowaniu opakowania, dlatego nasze projekty uwzględniają poszczególne elementy wynikające z technologicznych procesów produkcji. Inaczej mówiąc: myślimy o wszystkim.
                    </p>
                </div>
                </div>
            <div class="flexo-about__company-offer" id="offer">
                ...
                <div class="flexo-about__info">
                    <div class="flexo-about__company-offer-category">OFERTA</div>
                    <h2 class="flexo-about__company-offer--title">Studio reprograficzne</h2>
                    <p class="flexo-about__company-offer--text">Zespół operatorów przy wykorzystaniu specjalistycznego oprogramowania opracowuje pliki graficzne w taki sposób, by po wydruku jak najwierniej odzwierciedlić kolorystykę wzoru klienta. Krzyżowe kontrole prac oraz profesjonalne wydruki proof pozwalają w pełni kontrolować proces od otrzymania plików danych, do momentu produkcji form drukowych.
                    </p>
                </div>
            </div>
            <div class="flexo-about__company-offer" id="offer">
                ...
                <div class="flexo-about__info">
                    <div class="flexo-about__company-offer-category">OFERTA</div>
                    <h2 class="flexo-about__company-offer--title">Formy drukowe</h2>
                    <p class="flexo-about__company-offer--text">Jednym z najważniejszych elementów w druku fleksograficznym są formy drukowe (płaskie oraz bezkońcowe). Dedykujemy do druku matryce produkowane w wielokrotnie nagradzanej technologii Kodak Flexcel NX.
                        Zdobyte doświadczenie, pozwoliło nam uzyskać doskonałe rezultaty w jakości druku i dokładności odwzorowania projektów zarówno przy krótkich seriach, jak i drukach wielonakładowych. Płyty dostarczamy w ciągu 24 godzin od akceptacji wydruku proof.
        ...
        <div class="container flexo-numbers__container">
            <div class="flexo-numbers__item">
                ...
                <p class="flexo-numbers__description">
                    Tyle projektów realizujemy w ciągu roku
                </p>
            </div>
            <div class="flexo-numbers__item">
                <div class="circle">
                ...
                <div class="flexo-rolled-divider"></div>
                <p class="flexo-numbers__description">
                    Tyle opakowań trafia do naszych klientów każdego miesiąca
                </p>
            </div>
            <div class="flexo-numbers__item">
                <div class="circle">
            ...
            <!--</span>-->
                <div class="flexo-rolled-divider"></div>
                <p class="flexo-numbers__description">
                    Tylu klientów zaufało naszym usługom
                </p>
            </div>
        </div>
    </section>
    <section class="flexo-people">
        <div class="container flexo-people__container">
            ...
            <div class="flexo-people__employees">
                ...
                <p class="flexo-people__employees-employee-info">Lubię poznawać ludzi i świat. Lubię czerpać pomysły z książek i otoczenia pełnego ciekawych zdarzeń. Biuro jest dla mnie przestrzenią kreatywnego działania. Praca jest wspaniałym uzupełnieniem życia. W wolnym czasie skupiam się na treningu funkcjonalnym oraz core. Upór jest moją siłą.</p>
            </div>
        </div>
    </section>
  <section id="contact">
      ...
      <div class="flexo-info">
          ...
          <section class="flexo-information">
              <div class="container">
                  <h2 class="flexo-information__title">Dane firmy</h2>
