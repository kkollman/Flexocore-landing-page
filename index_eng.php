...
if(isset($_POST['submit'])){
    ...
    $mailSent = "Thank you for your message, we'll try to reach out to you as soon, as possible.";
    }
?>
<!DOCTYPE html>
<html>
  <head>
    ...
    <title>Flexocore – The core of printing and packaging</title>
    ...
    <link href="https://fonts.googleapis.com/css?family=Roboto:300,400,500&amp;subset=latin-ext" rel="stylesheet">
      ...
      <meta name="description" content="Flexocore was founded with a passion for printing and creating the best solutions for customers. Thanks to modern technologies and high quality materials, we create more than just designs.">
  </head>
  <body>
  <?php if($mailSent) : ?>
  ...
  <section class="flexo__nav" id="top">
          ...
          <section class="flexo-modal mobile">
              <div class="container">
                  <div class="flexo-modal__menu">
                      <a href="#company"><div class="flexo-modal__menu-element">Company</div></a>
                      <a href="#offer"><div class="flexo-modal__menu-element">Our offer</div></a>
                      <a href="#about"><div class="flexo-modal__menu-element">About us</div></a>
                      <a href="#contact"><div class="flexo-modal__menu-element">Contact</div></a>
          ...
          <div class="flexo-topbar__container">
              <nav class="flexo-topbar__menu">
                  ...
                  <div class="flexo-topbar__menu-element flexo-topbar__menu-list desktop">
                      <a href="#company"><div class="flexo-topbar__menu-list-element">Company</div></a>
                      <a href="#offer"><div class="flexo-topbar__menu-list-element">Our offer</div></a>
                      <a href="#about"><div class="flexo-topbar__menu-list-element">About us</div></a>
                      <a href="#contact"><div class="flexo-topbar__menu-list-element">Contact</div></a>
                      <div class="flexo-topbar__menu-language-header flexo-topbar__menu-list-element" id="language-dropdown-button">
                          ...
                          <div class="flexo-languages">
                              <a><div class="flexo-menu__language-list-element">EN</div></a>
    ...
    <section class="flexo-landing">
      ...
      <div class="flexo-landing__header">
        <h1 class="header flexo__title">The core of printing <br>and packaging</h1>
      </div>
    </section>
    <section class="flexo-about" id="company">
        <div class="container">
                <div class="flexo-about__header">
                    <h2 class="flexo-about__header--title">Company</h2>
                    <p class="flexo-about__header--into">Flexocore was founded with a passion for printing and creating the best solutions for customers, by an engineer with many years of experience in printing houses in Europe. Thanks to modern technologies and high quality materials, we create more than just designs. We create ideas and pour them into finished products and solutions, making art out of our work.
                    </p>
            ...
            <div class="flexo-about__company-offer" id="offer">
                ...
                <div class="flexo-about__info">
                    <div class="flexo-about__company-offer-category">OUR OFFER</div>
                    <h2 class="flexo-about__company-offer--title">Design</h2>
                    <p class="flexo-about__company-offer--text">We create logos and graphics for individual packages or whole series with consistent appearance and aesthetics. When working with accepted designs, from the beginning we prepare them having in mind printing and packaging formation, so our designs include given elements stemming from technological production processes. In other words: we think about everything.
                    </p>
                </div>
                </div>
            <div class="flexo-about__company-offer" id="offer">
                ...
                <div class="flexo-about__info">
                    <div class="flexo-about__company-offer-category">OUR OFFER</div>
                    <h2 class="flexo-about__company-offer--title">Reprographic studio</h2>
                    <p class="flexo-about__company-offer--text">The team of operators uses specialized software to process graphic files in such a way that after printing they reflect the colors of the customer's design as accurately as possible. Cross control of the work and professional proof printing allows you to fully control the process from receiving data files to production of printing forms.
                    </p>
                </div>
            </div>
            <div class="flexo-about__company-offer" id="offer">
                ...
                <div class="flexo-about__info">
                    <div class="flexo-about__company-offer-category">OUR OFFER</div>
                    <h2 class="flexo-about__company-offer--title">Printing forms</h2>
                    <p class="flexo-about__company-offer--text">One of the most important elements in flexographic printing are printing forms (flat and endless). For printing we use matrices produced in the award-winning Kodak Flexcel NX technology. The experience we gained allows us to obtain excellent results in print quality and accuracy of project mapping, both in short series and high volume printing. The discs are delivered within 24 hours from the acceptance of the proof printout.
                    </p>
                </div>
            </div>
            <div class="flexo-about__company-offer" id="offer">
                ...
                <div class="flexo-about__info">
                    <div class="flexo-about__company-offer-category">OUR OFFER</div>
                    <h2 class="flexo-about__company-offer--title">Packaging</h2>
                    <p class="flexo-about__company-offer--text">Final product. Completion of work of many people and the end result of many complex processes. We provide our customers with soft film packaging suitable for laminates content, in a selected format and design, with appropriate additives. In addition to the quality of workmanship and nice appearance on the shelf, the packaging is designed to act as a barrier, to be easy to open and close again and to be durable.
                        We help you to adapt your technology to the product, ensuring that the packaging process takes place at every stage of its development.
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="container flexo-numbers__container">
            <div class="flexo-numbers__item">
                ...
                <p class="flexo-numbers__description">
                    This is the number of projects we fulfil every year
                </p>
            </div>
            <div class="flexo-numbers__item">
                <div class="circle">
                ...
                <div class="flexo-rolled-divider"></div>
                <p class="flexo-numbers__description">
                    The number of packages sent to our customers every month
                </p>
            </div>
            <div class="flexo-numbers__item">
                <div class="circle">
            ...
            <!--</span>-->
                <div class="flexo-rolled-divider"></div>
                <p class="flexo-numbers__description">
                    The number of clients who placed their trust in us
                </p>
            </div>
        </div>
    </section>
    <section class="flexo-people">
        <div class="container flexo-people__container">
                <div class="flexo-people__employees">
                    ...
                    <p class="flexo-people__employees-employee-info">I like to act quickly and precisely. I also like to know how machines and devices work or why they do not work :) In my work I plan tasks and focus on the goal. I am interested in specific solutions. In private life, my passion is long-distance running which I have been training continuously for several years. I never give up.</p>
                </div>
            <div class="flexo-people__employees">
                <div class="flexo-people__employees--employee-header">
                    <div class="flexo-people__employees--employee-img-container">
                ...
                <p class="flexo-people__employees-employee-info">I like to get to know people and the world. I like to take ideas from books and an environment full of interesting events. For me, the office is a space for creative activity. Work is a wonderful complement to life. In my spare time I focus on functional and core training. Resilience is my strength.</p>
            </div>
        </div>
    </section>
  <section id="contact">
      ...
      <p class="flexo-contact__story">
          ...
          Call us, write us, visit us - we will be happy to provide you with information.
      </p>
      <div class="flexo-info">
          <section class="flexo-contact">
              <div class="container flexo-contact__wrapper">
                  <form name="flexo-contact" method="POST" action="index_eng.php">
                      ...
                      <input type="tel" class="flexo-contact__input" placeholder="Phone" name="phone">
                      <textarea class="flexo-contact__textarea" name="message" id="flexo-contact" cols="30" rows="8" placeholder="Message"></textarea>
                      <button class="flexo-contact__button" type="submit" name="submit">Send message<svg width="25" height="18" xmlns="http://www.w3.org/2000/svg"><path d="M16.835.27a.868.868 0 0 0-1.26 0 .926.926 0 0 0 0 1.278l6.388 6.542H.882c-.491 0-.882.4-.882.903 0 .504.39.917.882.917h21.081l-6.388 6.53a.942.942 0 0 0 0 1.29c.352.36.92.36 1.26 0l7.9-8.091a.903.903 0 0 0 0-1.277L16.836.27z" fill="#FFF" fill-rule="nonzero"/></svg>
                      </button>
                  </form>
              </div>
          </section>
          <section class="flexo-information">
              <div class="container">
                  <h2 class="flexo-information__title">Company address</h2>
